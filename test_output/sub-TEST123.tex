...
\fancypagestyle{firstpage}{
  ...
  \fancyhead[L]{
    \includegraphics[height=1.2cm]{/Volumes/Evo/software/participant_barcode/subject_info/psychologo.png}\hspace{1em}
    \includegraphics[height=1.2cm]{/Volumes/Evo/software/participant_barcode/subject_info/mrilab.png}
  }
  \fancyhead[R]{
    \includegraphics[height=1.2cm]{/Volumes/Evo/software/participant_barcode/subject_info/unigrazlogo.png}
  }
  ...
  \begin{minipage}[t]{\linewidth}
    ...
    \fbox{%
      \begin{minipage}[c][2.5cm][c]{4cm}  % slightly taller to fit text below
        \centering
        \includegraphics[height=1.5cm]{../barcodes/barcode_TEST123.png}
...
\hline
Bestehen chronische Erkrankungen? \newline Wenn ja, welche: \rule{9cm}{0.4pt} & Ja \checkbox\ Nein \checkbox \\
\hline
